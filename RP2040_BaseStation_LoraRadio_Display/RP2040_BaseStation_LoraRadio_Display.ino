 ...
 * and makes it available to the ESP32 to display on a webpage. The firmware outputs GNSS serial data
 * to the RP2040 USB serial port and displays information to a TFT screen.
 *
...
void setup() 
{
    ...
    // a0 a1 00 11 20   01 00 01 01 00  01 01 01 01 0a 00 0a 0a 01 02 00 28 0d 0a  
